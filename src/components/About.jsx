      ...
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-9 mb-8">
            I am Devansh Kolhe, a passionate Frontend Developer focused on
            building responsive, modern and user-friendly websites using
            React, JavaScript and Tailwind CSS.
          </p>

          <p className="text-gray-300 text-lg leading-9 mb-10">
            I enjoy creating clean interfaces, solving UI challenges and
